...
plot(tArr,statesArr(11,:)*180/pi,RspCol,tArr,OmegaRefA_BodyArr(1,:)*180/pi,CmdCol, 'LineWidth', 2);
ylabel('p (deg/s)');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,statesArr(12,:)*180/pi,RspCol,tArr,OmegaRefA_BodyArr(2,:)*180/pi,CmdCol, 'LineWidth', 2);
ylabel('q (deg/s)');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,statesArr(13,:)*180/pi,RspCol,tArr,OmegaRefA_BodyArr(3,:)*180/pi,CmdCol, 'LineWidth', 2);
ylabel('r (deg/s)');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,quats(:,1),RspCol, 'LineWidth', 2);
ylabel('q1');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,quats(:,2),RspCol, 'LineWidth', 2);
ylabel('q2');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,quats(:,3),RspCol, 'LineWidth', 2);
ylabel('q3');

lm(kk) = subplot(nRows,nCols,kk); kk = kk + 1; hold on;
plot(tArr,quats(:,4),RspCol, 'LineWidth', 2);
ylabel('q4');
