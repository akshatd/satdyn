classdef SatelliteClass < handle & matlab.mixin.Heterogeneous
    ...
    methods (Static)
        ...
        function [g,h] = constr_fun_MPC_Option4(Uarr,Xk_MPC4,ell,W_mag_rads_limit,params,Energy2React_Total_J)
            ...
            omega_reac_limit = params.Omega1_Limit_RPM*2*pi/60;
            ...
            % g2 = sqrt(omega_reac_Arr(1,:).^2 + omega_reac_Arr(2,:).^2) - omega_reac_limit;
            % g3 = -sqrt(omega_reac_Arr(1,:).^2 + omega_reac_Arr(2,:).^2)- omega_reac_limit;
